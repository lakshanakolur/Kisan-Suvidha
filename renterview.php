    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Control Panel <span class="caret"></span> </a>
              ...
              <li> <a href="renterview.php">View</a></li>
...
<?php $login_renter = $_SESSION['login_renter']; 

    $sql1 = "SELECT * FROM rentedcars rc, rentercars cc, customers c, cars WHERE cc.renter_username = '$login_renter' AND cc.car_id = rc.car_id AND rc.return_status = 'R' AND c.customer_username = rc.customer_username AND cc.car_id = cars.car_id";
...
<?php        } ?>
        ...
        <div class="container">
      <div class="jumbotron">
        <h1>No booked Equipments</h1>
        <p> Rent some equipments now! <?php echo $conn->error; ?> </p>
      </div>
    </div>
