...
?>
    ...
    <div style="background-color: white; margin-left: 190px; margin-right: 190px">
    <h2 class="text-center"> Thank you for visiting Kisan Suvidha!</h2>

    <h3 class="text-center"> <strong>Your Order Number:</strong> <span style="color: blue;"><?php echo "$id"; ?></span> </h3>
    </div>

    <div class="container">
        <h5 class="text-center" style="color: black; background-color: white">Please read the following information about your order.</h5>
        <div class="box">
