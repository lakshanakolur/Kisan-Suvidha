...
<div class="container">
      <div class="jumbotron">
        <h1>Return your equipments here</h1>
        <p> Hope you enjoyed our service! </p>
      </div>
    </div>

    <div class="table-responsive" style="padding-left: 100px; padding-right: 100px; background-color: white; margin-left: 190px; margin-right: 190px;">
...
?></td>
<td><a href="returneq.php?id=<?php echo $row["id"];?>"> Return </a></td>
</tr>
<?php        } ?>
                </table>
                </div> 
