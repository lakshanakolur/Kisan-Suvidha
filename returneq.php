    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <h6 style="margin-bottom: 25px; text-align: center; font-size: 12px;"> Allow your Helper to fill the below form </h6>

           <h5> Equipment:&nbsp;  <?php echo($car_name);?></h5>

           <h5> Equipment Number:&nbsp;  <?php echo($car_nameplate);?></h5>
           ...
           <h5> Helper Name:&nbsp;  <?php echo($driver_name);?></h5>

           <h5> Helper Contact:&nbsp;  <?php echo($driver_phone);?></h5>
...
<footer class="site-footer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h5 style="color: black">© 2018 Kisan Suvidha</h5>
                </div>
            </div>
        </div>
    </footer>
