...
<html>
  ...
  <head>
    <title> customer Signup | Kisan Suvidha </title>
  </head>
...
if (!empty($_FILES["uploadedimage"]["name"])) {
    ...
    if(move_uploaded_file($temp_name, $target_path)) {
      ...
      //  $query0 = "UPDATE cars SET car_img = '$target_path' WHERE ";
        ...
        $query = "INSERT into cars(car_name,car_nameplate,car_img,ac_price,ac_price_per_day,car_availability) VALUES('" . $car_name . "','" . $car_nameplate . "','".$target_path."','" . $ac_price . "','" . $ac_price_per_day . "','" . $car_availability ."')";
        $success = $conn->query($query);
