<?php
include('login_renter.php'); // Includes Login Script

if(isset($_SESSION['login_renter'])){
    header("location: indexrenter.php"); //Redirecting
}
?>
    ...
    <head>
        <title> Renter Login | Eq Rental </title>
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: white; background-color: black">
        ...
        <div class="container">
            <div class="jumbotron" style="opacity: 0.7">
                <h1>Welcome to Kisan Suvidha </span>
                </h1>
                <br>
        ...
        <div class="container" style="margin-top: -2%; margin-bottom: 2%;">
            <div class="col-md-5 col-md-offset-4">
                            ...
                            <div class="row">
                                <div class="form-group col-xs-12">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" id="renter_username" type="text" name="renter_username" placeholder="Username" required="" autofocus="">
                ...
                <label class="btn btn-primary"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></label>
                            ...
                            <label style="margin-left: 5px;"><a href="rentersignup.php">Create a new account.</a></label>
                        </form>
                    </div>
                </div>
            </div>
